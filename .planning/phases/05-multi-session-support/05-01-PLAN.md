...
<task type="auto">
  ...
  This sends the file path (e.g., `/Users/you/Documents/Presentation1.pptx`) for saved files, or `null` for unsaved/standalone mode. The server uses this to identify the presentation.
